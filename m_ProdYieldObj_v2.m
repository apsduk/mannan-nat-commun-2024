% ------------------------------------------------------------------------
% CALCULATING OBJECTIVES (II)  PRODUCT YIELD
% ------------------------------------------------------------------------
% Alexander P.S. Darlington
% ------------------------------------------------------------------------
function [Objs, T, Y, flag, tsol, ysol] = m_ProdYieldObj(p, hPR0, xPR0, Y0scales, SysTopol, tmax, xidx, odesolver, odeoptions)
...
% [Objs, T, Y, flag, tsol, ysol] = m_SimBatchCult_ProdPerf(hPR, xPR, Y0scales, SysTopol, tind, tmax, odesolver, odeoptions);
Objs = (-1)*Objs(2);
